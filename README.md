...
You can run the (unfinished) demo at code/build/VulkanParticleSystem.exe, but no guarantees are made that it will behave correctly as it was designed speifically for the capabilities of my testing hardware.
