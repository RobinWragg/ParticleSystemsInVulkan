...
A Windows application was built in C++17, using SDL 2.0.10 (\citeyear{SDL2}) for window creation and frame duration calculation. GLM 0.9.9.6 (\citeyear{GLM}) was used to provide a 3D vector class and some mathematical functions.
