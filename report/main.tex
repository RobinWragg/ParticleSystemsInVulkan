...
Debugging the program showed that the new multithreading code was performing as expected, so attention was given to the library function being used for random number generation (RNG), \verb||
