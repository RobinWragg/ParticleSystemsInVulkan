...
Initial measurements were taken of the program's frame durations (Figure \ref{fig:initialtimes}).

\begin{figure}[h]
\includegraphics[width=\linewidth]{initialtimes}
\caption{Frame durations for different particle counts before any optimisations were performed.}
