...
A \verb|particles.cpp| file was created that 

A Vulkan 1.1 graphics system was created that consumes an array of \verb|Particle| structures containing 3D positions and scalar brightness values as shown:
