...
\begin{center}
\includegraphics[width=10cm]{particles}
\end{center}
...
This technique was repeated for the entire body of code responsible for spawning and updating particles. As shown in Figure \ref{fig:nosimd-simd}, this gave a speedup of approximately 25\% overall, scaling linearly with the particle count.
...
\begin{itemize}
\item Windows 10.0.17763 with Windows SDK 10.0.16299 
